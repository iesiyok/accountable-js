...
/***/ "./node_modules/@nimiq/ledger-api/dist/high-level-api/lazy-chunk-request-sign-transaction-bitcoin.es.js":
/*!**************************************************************************************************************!*\
  !*** ./node_modules/@nimiq/ledger-api/dist/high-level-api/lazy-chunk-request-sign-transaction-bitcoin.es.js ***!
  \**************************************************************************************************************/
...
class RequestSignTransactionBitcoin extends _lazy_chunk_request_bitcoin_es_js__WEBPACK_IMPORTED_MODULE_1__["R"] {
    constructor(transaction, expectedWalletId) {
        super(expectedWalletId);
        this.type = _ledger_api_es_js__WEBPACK_IMPORTED_MODULE_2__["RequestTypeBitcoin"].SIGN_TRANSACTION;
        ...
        try {
            ...
            throw new _ledger_api_es_js__WEBPACK_IMPORTED_MODULE_2__["ErrorState"](_ledger_api_es_js__WEBPACK_IMPORTED_MODULE_2__["ErrorType"].REQUEST_ASSERTION_FAILED, `Invalid request: ${e.message || e}`, this);
        }
    ...
    async call(transport) {
        ...
        try {
            ...
            parsedTransaction = {
                ...
                outputScriptHex: typeof outputs === 'string'
                    ...
                    : api.serializeTransactionOutputs({
                        outputs: outputs.map((output) => {
                            ...
                            const amountBuffer = _lazy_chunk_polyfill_node_buffer_es_js__WEBPACK_IMPORTED_MODULE_0__["B"].alloc(8);
                            ...
                            if ('outputScript' in output) {
                                outputScript = _lazy_chunk_polyfill_node_buffer_es_js__WEBPACK_IMPORTED_MODULE_0__["B"].from(output.outputScript, 'hex');
                            }
                            else {
                                outputScript = bitcoinLib.address.toOutputScript(output.address, this.network === _ledger_api_es_js__WEBPACK_IMPORTED_MODULE_2__["Network"].MAINNET
                ...
                segwit: this._inputType !== _ledger_api_es_js__WEBPACK_IMPORTED_MODULE_2__["AddressTypeBitcoin"].LEGACY,
                additionals: this._inputType === _ledger_api_es_js__WEBPACK_IMPORTED_MODULE_2__["AddressTypeBitcoin"].NATIVE_SEGWIT ? ['bech32'] : [],
            };
...
/* harmony default export */ __webpack_exports__["default"] = (RequestSignTransactionBitcoin);
...
//# sourceMappingURL=36-legacy.js.map