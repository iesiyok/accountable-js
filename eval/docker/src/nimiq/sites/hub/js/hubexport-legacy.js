...
/* harmony import */ var _lib_CashlinkStore__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lib/CashlinkStore */ "./src/lib/CashlinkStore.ts");
/* harmony import */ var _lib_Helpers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./lib/Helpers */ "./src/lib/Helpers.ts");



async function main() {
    await Object(_lib_Helpers__WEBPACK_IMPORTED_MODULE_2__["loadNimiq"])();
    const store = _lib_CashlinkStore__WEBPACK_IMPORTED_MODULE_1__["CashlinkStore"].Instance;
    const cashlinkEntries = await store.list();
    const $ul = document.querySelector('#cashlinks');
    $ul.innerHTML = '';
    for (const entry of cashlinkEntries) {
        const cashlink = _lib_Cashlink__WEBPACK_IMPORTED_MODULE_0__["default"].fromObject(entry);
...
module.exports = __webpack_require__(/*! /Users/iesiyok/projects/acc-js/development/nimiq2/hub/src/export.ts */"./src/export.ts");


/***/ })

/******/ });
//# sourceMappingURL=hubexport-legacy.js.map