...
/***/ "./node_modules/@nimiq/ledger-api/dist/high-level-api/lazy-chunk-index.es.js":
/*!***********************************************************************************!*\
  !*** ./node_modules/@nimiq/ledger-api/dist/high-level-api/lazy-chunk-index.es.js ***!
  \***********************************************************************************/
/*! exports provided: D, T, a, b, c, d, e, f, g, l */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "D", function() { return DisconnectedDeviceDuringOperation; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "T", function() { return Transport; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TransportError; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return DisconnectedDevice; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return TransportOpenUserCancelled; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return dist; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return TransportInterfaceNotAvailable; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return TransportWebUSBGestureRequired; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return libEs; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return log; });
...
/* harmony import */ var _lazy_chunk_events_es_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lazy-chunk-events.es.js */ "./node_modules/@nimiq/ledger-api/dist/high-level-api/lazy-chunk-events.es.js");
...
class Transport {
  constructor() {
    ...
    this._events = new _lazy_chunk_events_es_js__WEBPACK_IMPORTED_MODULE_1__["e"]();

    this.send = async (cla, ins, p1, p2, data = _lazy_chunk_polyfill_node_buffer_es_js__WEBPACK_IMPORTED_MODULE_0__["B"].alloc(0), statusList = [StatusCodes.OK]) => {
      if (data.length >= 256) {
        throw new TransportError("data.length exceed 256 bytes limit. Got: " + data.length, "DataLengthTooBig");
      }

      const response = await this.exchange(_lazy_chunk_polyfill_node_buffer_es_js__WEBPACK_IMPORTED_MODULE_0__["B"].concat([_lazy_chunk_polyfill_node_buffer_es_js__WEBPACK_IMPORTED_MODULE_0__["B"].from([cla, ins, p1, p2]), _lazy_chunk_polyfill_node_buffer_es_js__WEBPACK_IMPORTED_MODULE_0__["B"].from([data.length]), data]));
...
//# sourceMappingURL=2-legacy.js.map